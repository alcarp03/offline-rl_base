...
from .torch.redq_impl import DiscreteREDQImpl, REDQImpl
...
class DiscreteSAC(AlgoBase):
    ...
    _use_gpu: Optional[Device]
    _impl: Optional[DiscreteREDQImpl]
    ...
    def __init__(
        ...
        *,
        ...
        scaler: ScalerArg = None,
        reward_scaler: RewardScalerArg = None,
        impl: Optional[DiscreteREDQImpl] = None,
        **kwargs: Any
    ):
        super().__init__(
            batch_size=batch_size,
