...
from .torch.bred_impl import DiscreteBREDImpl, BREDImpl
...
class DiscreteBRED(AlgoBase):
    ...
    _use_gpu: Optional[Device]
    _impl: Optional[DiscreteBREDImpl]
    ...
    def __init__(
        ...
        *,
        ...
        scaler: ScalerArg = None,
        reward_scaler: RewardScalerArg = None,
        impl: Optional[DiscreteBREDImpl] = None,
        **kwargs: Any
    ):
        super().__init__(
            batch_size=batch_size,
